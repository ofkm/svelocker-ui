...
<svelte:head>
	<title>Settings | {data.registryName}</title>
	...
	<div class="grid gap-6 md:grid-cols-2">
		<Card class="md:col-span-2">
			<CardHeader>
				...
				<CardDescription>Manage registry sync and connection settings</CardDescription>
			</CardHeader>
			<CardContent>
				<div class="space-y-6">
		...
		<Card>
			...
			<CardContent class="space-y-4">
				...
				<div>
					...
					<p class="text-sm text-muted-foreground mt-1">{registryUrl || 'Not configured'}</p>
				</div>
